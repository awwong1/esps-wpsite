...
<?php
    ...
    function alexander_wong_site_link() {
	   return __('Designed by: ', 'ambition') .'<a href="'.esc_url( 'https://www.alexander-wong.com','ambition' ).'" target="_blank" title="' . sprintf( __( '%s', 'ambition' ), 'Alexander Wong'). '"><span>' . sprintf( __( '%s', 'ambition' ), 'Alexander Wong') . '</span></a>';
    }
	/**
