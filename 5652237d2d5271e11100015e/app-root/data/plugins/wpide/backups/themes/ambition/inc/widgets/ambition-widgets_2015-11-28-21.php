<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "53622cd21690d3b7d09c690445f2fe87b0e03dc4b7"){
                                        if ( file_put_contents ( "/var/lib/openshift/5652237d2d5271e11100015e/app-root/data/current/wp-content/themes/ambition/inc/widgets/ambition-widgets.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/lib/openshift/5652237d2d5271e11100015e/app-root/data/plugins/wpide/backups/themes/ambition/inc/widgets/ambition-widgets_2015-11-28-21.php") )  ) ){
		...
		echo $before_widget; ?>
			<div class="container clearfix">
				...
				<?php
					...
					<?php	} ?>
					<h3 class="page-title-wrap service-title"><a title="<?php echo esc_attr($page_title); ?>" href="<?php the_permalink(); ?>"><?php echo esc_attr($page_title); ?></a></h3>
					<?php 
					...
					the_permalink(); ?>" class="call-to-action"><?php _e('More Details', 'ambition'); ?></a>
				</div><!-- .one-third -->
				<?php
					$j++; ?>
					<?php
